...
- **3DPrintForge Slicer integration** — first-class REST connection to [3DPrintForge Slicer](https://github.com/skynett81/OrcaSlicer) (a custom OrcaSlicer fork) running in service mode: live SSE progress, automatic profile sync, slice-and-send to printer in one click. See [docs/forge-slicer-setup.md](website/docs/forge-slicer-setup.md)
