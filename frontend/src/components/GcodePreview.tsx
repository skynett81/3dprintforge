...
const FEATURE_LABEL: Record<Feature, string> = {
  ...
  solid: 'Top/bottom', sparse: 'Infill', support: 'Support', skirt: 'Skirt', brim: 'Brim',
};
const LEGEND_ORDER: Feature[] = ['outer-wall', 'inner-wall', 'solid', 'sparse', 'support', 'skirt', 'brim', 'wall'];
