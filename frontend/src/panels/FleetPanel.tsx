...
export function FleetPanel() {
  ...
  async function addPrinter() {
    ...
    try {
      ...
      setAdding(false); setNw({ name: '', ip: '', type: 'moonraker', serial: '', accessCode: '' }); reload();
      ...
      {adding && (
        <section className="card">
          <div className="add-form add-form--stack">
            ...
            <button className="btn btn--primary" onClick={addPrinter}>{t('v2.printers.add_btn', 'Add')}</button>
          </div>
        </section>
      )}
