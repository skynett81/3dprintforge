...
const INFILL_PATTERNS = ['grid', 'gyroid', 'honeycomb', 'cubic', 'adaptivecubic', 'triangles', 'star', 'crosshatch', 'hilbert', 'lightning', 'line', 'rectilinear', 'alignedrectilinear', 'concentric'];
...
const FIELDS: Field[] = [
  ...
  { tab: 'Quality', group: 'Surface', k: 'monotonic_top_surface', label: 'Monotonic top/bottom surface', type: 'bool' },
  ...
  { tab: 'Strength', group: 'Walls', k: 'first_layer_wall_loops', label: 'First-layer wall loops', type: 'num', step: 1 },
  ...
  { tab: 'Strength', group: 'Walls', k: 'wall_infill_order', label: 'Wall order', type: 'sel', opts: [['outer-inner', 'Outer / inner'], ['inner-outer', 'Inner / outer'], ['inner-outer-inner', 'Inner / outer / inner']] },
  ...
  { tab: 'Quality', group: 'Line width', k: 'bridge_line_width', label: 'Bridge', type: 'num', unit: 'mm', step: 0.02 },
  { tab: 'Quality', group: 'Line width', k: 'support_line_width', label: 'Support', type: 'num', unit: 'mm', step: 0.02 },
  { tab: 'Quality', group: 'Line width', k: 'internal_solid_infill_line_width', label: 'Internal solid infill', type: 'num', unit: 'mm', step: 0.02 },
  { tab: 'Strength', group: 'Infill', k: 'gap_fill_flow', label: 'Gap fill flow ratio', type: 'num', step: 0.05, dep: 'gap_fill_enabled' },
  { tab: 'Support', group: 'Support', k: 'support_grid_resolution', label: 'Grid resolution', type: 'num', unit: 'mm', step: 0.5, dep: 'supports' },
  { tab: 'Others', group: 'Adhesion', k: 'draft_shield_distance', label: 'Draft shield distance', type: 'num', unit: 'mm', step: 0.5, dep: 'draft_shield' },
  { tab: 'Others', group: 'Adhesion', k: 'raft_expansion', label: 'Raft expansion', type: 'num', unit: 'mm', step: 0.5, dep: 'raft_layers' },
  ...
  { tab: 'Speed', group: 'Other', k: 'travel_speed_z', label: 'Travel (Z)', type: 'num', unit: 'mm/s', step: 1 },
  { tab: 'Speed', group: 'Other', k: 'wipe_speed', label: 'Wipe', type: 'num', unit: 'mm/s', step: 5, dep: 'wipe' },
  ...
  { tab: 'Speed', group: 'Acceleration', k: 'gap_infill_acceleration', label: 'Gap fill', type: 'num', unit: 'mm/s²', step: 100 },
  { tab: 'Speed', group: 'Jerk', k: 'default_jerk', label: 'Jerk (max)', type: 'num', unit: 'mm/s', step: 1 },
  { tab: 'Speed', group: 'Machine limits', k: 'machine_max_acceleration', label: 'Max acceleration (M201)', type: 'num', unit: 'mm/s²', step: 500 },
  { tab: 'Speed', group: 'Machine limits', k: 'machine_max_speed', label: 'Max feedrate (M203)', type: 'num', unit: 'mm/s', step: 10 },
  { tab: 'Speed', group: 'Machine limits', k: 'machine_max_jerk', label: 'Max jerk (M205)', type: 'num', unit: 'mm/s', step: 1 },
  ...
  { tab: 'Speed', group: 'Jerk', k: 'infill_jerk', label: 'Infill', type: 'num', unit: 'mm/s', step: 1 },
  { tab: 'Speed', group: 'Jerk', k: 'top_surface_jerk', label: 'Top surface', type: 'num', unit: 'mm/s', step: 1 },
  { tab: 'Speed', group: 'Jerk', k: 'initial_layer_jerk', label: 'Initial layer', type: 'num', unit: 'mm/s', step: 1 },
  ...
  { tab: 'Others', group: 'Retraction', k: 'retract_restart_extra', label: 'Restart extra (prime)', type: 'num', unit: 'mm', step: 0.01 },
  ...
  { tab: 'Others', group: 'Multi-colour', k: 'wipe_tower_x', label: 'Wipe tower X', type: 'num', unit: 'mm', step: 5, dep: 'wipe_tower' },
