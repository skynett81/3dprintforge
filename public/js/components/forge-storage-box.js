  ...
  function _updatePreview() {
    ...
    result.innerHTML = `
      <div style="display:flex;gap:6px;flex-wrap:wrap;justify-content:center">
        <button class="form-btn form-btn-sm form-btn-info" data-ripple onclick="window._sboxPreview3D()">🧊 3D Preview</button>
        <button class="form-btn form-btn-sm form-btn-success" data-ripple onclick="window._sboxDownload()"><i class="bi bi-download"></i> Download 3MF</button>
      </div>
