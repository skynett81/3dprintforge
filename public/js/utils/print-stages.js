...
(function() {
  ...
  const STAGES = {
    ...
    10: { key: 'inspecting_first_layer',nb:'Inspiserer forste lag',      en: 'Inspecting first layer',        icon: I.search,   color: 'var(--accent-blue)' },
    ...
    13: { key: 'homing',              nb: 'Homing av verktoyhodde',      en: 'Homing toolhead',               icon: I.home,     color: 'var(--accent-blue)' },
    ...
    25: { key: 'motor_noise_cal',     nb: 'Motorkalibrering (stoy)',      en: 'Motor noise calibration',       icon: I.volume,   color: 'var(--accent-blue)' },
    ...
    29: { key: 'cooling_chamber',     nb: 'Kjoler ned kammer',           en: 'Cooling chamber',               icon: I.snow,     color: 'var(--accent-blue)' },
    30: { key: 'gcode_pause',         nb: 'Pause fra G-kode',            en: 'Paused by G-code',              icon: I.pause,    color: 'var(--accent-orange)' },
    31: { key: 'motor_noise_showoff', nb: 'Motorstoy-demo',              en: 'Motor noise showoff',           icon: I.volume,   color: 'var(--text-muted)' },
    ...
    34: { key: 'first_layer_error',   nb: 'Pause — forstelagsfeil',      en: 'Paused: first layer error',     icon: I.alert,    color: 'var(--accent-red)' },
