...
export const DRYING_RECOMMENDATIONS = [
  ['PLA', 55, 8, 'Dry if you hear popping or see stringing'],
  ['PLA Matte', 55, 8, 'Same as standard PLA'],
  ['PLA Silk+', 55, 8, 'Careful with high temp — may damage gloss'],
  ['PLA-CF', 55, 8, 'Carbon fiber reinforced — dry like standard PLA'],
  ['PLA Aero', 55, 8, 'Lightweight PLA — standard drying'],
  ['PETG', 65, 8, 'Absorbs moisture over 1–3 weeks in open air'],
  ['PETG HF', 65, 8, 'High Flow PETG — same drying as standard'],
  ['PETG-CF', 65, 8, 'Carbon fiber reinforced PETG'],
  ['ABS', 80, 8, 'Less moisture sensitive, but drying improves results'],
  ['ABS-GF', 80, 8, 'Glass fiber reinforced — standard ABS drying'],
  ['ASA', 80, 8, 'UV stable — dry like ABS'],
  ['ASA-CF', 80, 8, 'Carbon fiber reinforced ASA'],
  ['PC', 80, 12, 'Polycarbonate — very moisture sensitive'],
  ['PC FR', 80, 12, 'Flame retardant PC — dry thoroughly'],
  ['PA', 90, 12, 'Nylon — extremely moisture sensitive, must be bone dry'],
  ['PA-CF', 90, 12, 'Carbon fiber nylon — always dry before use'],
  ['PA6-CF', 90, 12, 'PA6 carbon fiber — requires thorough drying'],
  ['PA6-GF', 90, 12, 'PA6 glass fiber — very hygroscopic'],
  ['PAHT-CF', 90, 12, 'High temperature PA — dry at least 12 hours'],
  ['PPA-CF', 90, 12, 'PPA carbon fiber — requires long drying time'],
  ['TPU', 55, 6, 'Flexible filament — absorbs moisture quickly'],
  ['TPU for AMS', 55, 6, 'AMS compatible TPU'],
  ['PVA', 55, 8, 'Support material — very moisture sensitive'],
  ['Support', 55, 6, 'Support material for PLA/PETG'],
];
