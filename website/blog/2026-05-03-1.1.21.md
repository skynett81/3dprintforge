---
slug: 1.1.21
title: "v1.1.21 — 3DPrintForge Slicer Integration, Filament Overhaul, Security Hardening"
authors: [skynett81]
tags: [release]
---
...
If you set up the 3DPrintForge Slicer integration, see [the setup guide](/docs/forge-slicer-setup) for how to launch the fork in service mode and wire it up. The integration is **opt-in** — leaving `FORGE_SLICER_URL` blank disables it and slicing continues through the existing CLI bridge or native engine.
