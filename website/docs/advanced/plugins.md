...
sidebar_position: 4
title: Plugin-system
description: Lag og installer plugins for å utvide Bambu Dashboard
---

# Plugin-system

Bambu Dashboard støtter et plugin-system som lar deg utvide funksjonaliteten uten å endre kildekoden.
