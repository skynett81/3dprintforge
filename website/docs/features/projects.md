...
2. Fyll inn:
   ...
   - **Kunde** — valgfri kundekonto (se [E-handel](../integrations/ecommerce))
...
| Maskinslitasje | Beregnet fra [Slitasjepredikasjon](../monitoring/wearprediction) |
...
:::tip Timepriser
Aktivér Tibber- eller Nordpool-integrasjonen for nøyaktige strømkostnader per print. Se [Strømpris](../integrations/energy).
:::
...
:::info Kundedata
Kundedata (navn, adresse, org.nr.) hentes fra kundekontoen du koblet til prosjektet. Se [E-handel](../integrations/ecommerce) for å administrere kunder.
:::
