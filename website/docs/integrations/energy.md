...
3. I 3DPrintForge: lim inn token under **Tibber API Token**
...
Aktivert strømprisintegrasjon gir nøyaktige strømkostnader i [Kostnadsberegneren](../analytics/costestimator). Velg **Live pris** i stedet for fast pris for å bruke aktuell Tibber/Nordpool-pris.
