...
PEX er en høytemperatur-variant av smooth PEI, designet for å tåle temperaturer opp mot 135 °C. Ekstremt holdbar og gir blank underflate som standard Cool Plate, men tåler krevende materialer som PC og PAHT. Se [Spesialplater](./spesialplater) for full detaljer.
