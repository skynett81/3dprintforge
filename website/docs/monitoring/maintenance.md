...
3DPrintForge kommer med forhåndskonfigurerte vedlikeholdsintervaller for alle Bambu Lab-printermodeller:
...
4. Velg varselkanal (se [Varsler](../features/notifications))
