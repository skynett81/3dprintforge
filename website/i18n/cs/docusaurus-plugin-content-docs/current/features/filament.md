...
:::tip Cívky Bambu Lab
Oficiální cívky Bambu Lab lze importovat automaticky prostřednictvím integrace Bambu Cloud. Viz [Bambu Cloud](../getting-started/bambu-cloud).
:::
...
3DPrintForge podporuje NFC tagy pro rychlou identifikaci cívek:
