...
2. Vyplňte:
   ...
   - **Zákazník** — volitelný zákaznický účet (viz [E-commerce](../integrasjoner/ecommerce))
...
| Opotřebení stroje | Vypočítáno z [Predikce opotřebení](../overvaaking/wearprediction) |
...
:::tip Hodinové ceny
Aktivujte integraci Tibber nebo Nordpool pro přesné náklady na elektřinu pro každý tisk. Viz [Cena elektřiny](../integrasjoner/energy).
:::
...
Zákaznická data (jméno, adresa, IČO) se načítají ze zákaznického účtu propojeného s projektem. Viz [E-commerce](../integrasjoner/ecommerce) pro správu zákazníků.
:::
