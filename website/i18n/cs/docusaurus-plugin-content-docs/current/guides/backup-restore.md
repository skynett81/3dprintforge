...
sidebar_position: 9
title: Záloha
description: Automatické a manuální zálohování 3DPrintForge, obnova dat a přesun na nový server
---

# Záloha a obnova

3DPrintForge ukládá všechna data lokálně — historii tisků, zásoby filamentů, nastavení, uživatele a další. Pravidelné zálohování zajistí, že nepřijdete o nic při selhání serveru nebo při přesunu na jiný počítač.
...
Takto přesunete 3DPrintForge se všemi daty na nový počítač:
