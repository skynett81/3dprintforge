...
Aktivovaná integrace ceny elektřiny poskytuje přesné náklady na elektřinu v [Kalkulačce nákladů](../analyse/costestimator). Vyberte **Živá cena** místo pevné ceny pro použití aktuální ceny Tibber/Nordpool.
