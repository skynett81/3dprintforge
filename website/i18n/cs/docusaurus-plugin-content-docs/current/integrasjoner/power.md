...
- Shelly zásuvka je připojena ke stejné síti jako Bambu Dashboard
...
2. V Bambu Dashboardu: vyberte **Typ**: Tasmota
3. Zadejte MQTT topic zařízení: např. `tasmota/power-plug-1`
4. Propojte s tiskárnou a klikněte na **Uložit**

Bambu Dashboard se automaticky přihlásí k odběru `{topic}/SENSOR` pro měření výkonu.
...
Konzistentní odchylka může být použita ke kalibraci odhadů v [Kalkulačce nákladů](../analyse/costestimator).
