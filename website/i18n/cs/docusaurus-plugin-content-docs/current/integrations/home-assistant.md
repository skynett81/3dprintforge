...
description: Integrujte 3DPrintForge s Home Assistant přes MQTT Discovery, automatizované entity a příklady automatizací
---
...
- 3DPrintForge a Home Assistant používají stejný MQTT broker
...
3DPrintForge nyní zveřejňuje discovery zprávy pro všechny registrované tiskárny.
...
:::info Poznámka
Tlačítka (pauza/obnovení/zastavení) nejsou publikována přes MQTT Discovery. Pro odesílání příkazů z automatizací použijte API 3DPrintForgeu.
:::
