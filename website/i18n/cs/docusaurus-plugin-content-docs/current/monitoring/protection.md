...
Print Guard je systém monitorování Bambu Dashboardu v reálném čase. Nepřetržitě monitoruje kameru, senzory a data tiskárny a provádí konfiguratelné akce při výskytu problémů.
