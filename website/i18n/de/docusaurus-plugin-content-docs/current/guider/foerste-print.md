...
Wenn der Druck abgeschlossen ist, zeigt das Dashboard eine Abschlussmeldung an (und sendet eine Benachrichtigung, wenn Sie [Benachrichtigungen](./varsler-oppsett) eingerichtet haben).
...
- **Leere Spulen wiegen** — Startgewicht der Spulen eingeben für genaue Restberechnung (siehe [Filamentlager](./filament-oppsett))
- **Telegram-Benachrichtigungen einrichten** — Benachrichtigung erhalten, wenn der Druck fertig ist, ohne warten zu müssen (siehe [Benachrichtigungen](./varsler-oppsett))
- **Bauplatte prüfen** — Saubere Platte = bessere Haftung. Zwischen Drucken mit IPA (Isopropanol) abwischen
- **Richtige Platte verwenden** — siehe [Die richtige Bauplatte wählen](./velge-rett-plate) für das passende Filament
