...
Eine aktivierte Strompreisintegration liefert genaue Stromkosten im [Kostenkalkulator](../analyse/costestimator). Wählen Sie **Live-Preis** anstelle eines Festpreises, um den aktuellen Tibber/Nordpool-Preis zu verwenden.
