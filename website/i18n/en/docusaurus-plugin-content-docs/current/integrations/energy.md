...
Activated electricity price integration provides accurate electricity costs in the [Cost Calculator](../analytics/costestimator). Select **Live price** instead of fixed price to use the current Tibber/Nordpool price.
