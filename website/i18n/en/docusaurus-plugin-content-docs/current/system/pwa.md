...
sidebar_position: 5
title: PWA
description: Install 3DPrintForge as a Progressive Web App for an app-like experience, offline mode, and background notifications
---
...
5. 3DPrintForge opens as its own window without browser UI
