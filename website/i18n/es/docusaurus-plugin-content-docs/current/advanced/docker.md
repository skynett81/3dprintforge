...
description: Ejecuta Bambu Dashboard con Docker y docker-compose
---

# Configuración de Docker

Bambu Dashboard incluye un `Dockerfile` y `docker-compose.yml` para una contenedorización sencilla.
