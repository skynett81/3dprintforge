...
description: Crea e instala plugins para extender 3DPrintForge
---

# Sistema de plugins

3DPrintForge admite un sistema de plugins que te permite extender la funcionalidad sin modificar el código fuente.
