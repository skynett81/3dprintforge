...
2. Completa:
   ...
   - **Cliente** — cuenta de cliente opcional (ver [E-commerce](../integrasjoner/ecommerce))
...
| Desgaste de máquina | Calculado desde [Predicción de desgaste](../overvaaking/wearprediction) |
...
Activa la integración de Tibber o Nordpool para obtener costos eléctricos precisos por impresión. Ver [Precio de electricidad](../integrasjoner/energy).
:::
...
Los datos del cliente (nombre, dirección, número de registro) se obtienen de la cuenta de cliente que vinculaste al proyecto. Ver [E-commerce](../integrasjoner/ecommerce) para gestionar clientes.
:::
