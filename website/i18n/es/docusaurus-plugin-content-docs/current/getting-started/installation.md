...
En el primer inicio, el panel genera un certificado SSL autofirmado. El navegador mostrará una advertencia — esto es normal. Consulte [Certificados HTTPS](./setup#https-sertifikater) para instalar su propio certificado.
:::
...
Consulte [Configuración de Docker](../advanced/docker) para la configuración completa.
