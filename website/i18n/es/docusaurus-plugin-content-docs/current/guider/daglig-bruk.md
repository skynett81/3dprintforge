...
Ver la [documentación de la cola de impresión](../funksjoner/queue) para información completa sobre la gestión de la cola.
...
Ver [Planificador](../funksjoner/scheduler) para más detalles.
