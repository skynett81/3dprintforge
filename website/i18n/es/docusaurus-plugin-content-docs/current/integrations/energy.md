...
3. En 3DPrintForge: pega el token en **Token API de Tibber**
...
La integración de precio de electricidad activada proporciona costos de electricidad precisos en la [Calculadora de costos](../analytics/costestimator). Selecciona **Precio en vivo** en lugar de precio fijo para usar el precio actual de Tibber/Nordpool.
