...
3DPrintForge incluye intervalos de mantenimiento preconfigurados para todos los modelos de impresoras Bambu Lab:
...
4. Selecciona el canal de alerta (ver [Alertas](../features/notifications))
