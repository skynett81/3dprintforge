...
2. Selecciona un archivo `.json` exportado de otro Bambu Dashboard
3. Los perfiles existentes con el mismo nombre pueden sobreescribirse o mantenerse ambos

## Compartir perfiles

Comparte perfiles con otros mediante el módulo de filamentos de la comunidad (ver [Filamentos de la comunidad](../integrasjoner/community)) o mediante exportación directa de JSON.
