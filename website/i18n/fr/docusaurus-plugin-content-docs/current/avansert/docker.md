...
description: Exécutez Bambu Dashboard avec Docker et docker-compose
---

# Configuration Docker

Bambu Dashboard inclut un `Dockerfile` et un `docker-compose.yml` pour une conteneurisation facile.
