...
Les bobines officielles Bambu Lab peuvent être importées automatiquement via l'intégration Bambu Cloud. Voir [Bambu Cloud](../kom-i-gang/bambu-cloud).
:::
...
Bambu Dashboard prend en charge les étiquettes NFC pour identifier rapidement les bobines :
