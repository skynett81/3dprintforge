...
L'intégration de prix d'électricité activée fournit des coûts électriques précis dans l'[Estimateur de coûts](../analyse/costestimator). Sélectionnez **Prix en direct** au lieu d'un prix fixe pour utiliser le prix actuel Tibber/Nordpool.
