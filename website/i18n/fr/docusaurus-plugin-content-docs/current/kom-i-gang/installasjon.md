...
Au premier démarrage, le tableau de bord génère un certificat SSL auto-signé. Le navigateur affichera un avertissement — c'est normal. Consultez [Certificats HTTPS](./oppsett#https-sertifikater) pour installer votre propre certificat.
:::
...
Consultez [Configuration Docker](../avansert/docker) pour la configuration complète.
