...
3DPrintForge est livré avec des intervalles de maintenance préconfigurés pour tous les modèles d'imprimantes Bambu Lab :
...
4. Choisissez le canal de notification (voir [Notifications](../features/notifications))
