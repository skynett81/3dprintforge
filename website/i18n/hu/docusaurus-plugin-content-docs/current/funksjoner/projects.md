...
2. Töltsd ki:
   ...
   - **Ügyfél** — opcionális ügyfélfiók (lásd [E-kereskedelem](../integrasjoner/ecommerce))
...
| Gépkopás | Kiszámítva a [Kopásbecslésből](../overvaaking/wearprediction) |
...
:::tip Óránkénti árak
Aktiváld a Tibber- vagy Nordpool-integrációt a pontos nyomtatásonkénti áramköltségekhez. Lásd [Áramár](../integrasjoner/energy).
:::
...
:::info Ügyféladatok
Az ügyféladatok (név, cím, cégjegyzékszám) a projekthez csatolt ügyfélfiókból kerülnek elő. Az ügyfelek kezeléséhez lásd az [E-kereskedelem](../integrasjoner/ecommerce) oldalt.
:::
