...
Lásd az [Nyomtatási sor dokumentációja](../funksjoner/queue) oldalt a sorkezelés teljes leírásáért.
...
Lásd az [Ütemező](../funksjoner/scheduler) oldalt a részletekért.
