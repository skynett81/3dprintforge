...
Lásd az [Értesítések](./notification-setup) oldalt a beállításhoz.
...
- **Ellenőrizd az AMS szintjeket naponta**: Lásd a [Napi használat](./daily-use) oldalt a reggeli rutinhoz
