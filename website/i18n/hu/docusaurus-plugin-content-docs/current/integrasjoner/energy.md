...
Az aktivált áramár-integráció pontos áramköltségeket ad a [Költségkalkulátorban](../analyse/costestimator). Válaszd az **Élő ár** lehetőséget a fix ár helyett az aktuális Tibber/Nordpool ár használatához.
