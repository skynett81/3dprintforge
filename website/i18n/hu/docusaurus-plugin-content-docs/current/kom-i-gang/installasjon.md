...
Az első indításkor a dashboard automatikusan generál egy önaláírt SSL tanúsítványt. A böngésző figyelmeztetést fog megjeleníteni — ez normális. Lásd a [HTTPS tanúsítványok](./oppsett#https-tanúsítványok) részt saját tanúsítvány telepítéséhez.
:::
...
A teljes konfigurációért lásd a [Docker beállítás](../avansert/docker) oldalt.
