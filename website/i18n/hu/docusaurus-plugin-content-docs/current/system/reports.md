...
A 3DPrintForge automatikus e-mail jelentéseket tud küldeni statisztikákkal és tevékenységösszefoglalóval — hetente, havonta vagy mindkettő.
...
4. Válassz **Logó megjelenítést**: mutassa a 3DPrintForge logót a fejlécben, vagy kapcsolja ki
5. Kattints a **Mentés** gombra
