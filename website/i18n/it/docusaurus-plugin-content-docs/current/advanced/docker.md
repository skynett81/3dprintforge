...
description: Esegui 3DPrintForge con Docker e docker-compose
---

# Configurazione Docker

3DPrintForge include un `Dockerfile` e `docker-compose.yml` per una containerizzazione semplice.
