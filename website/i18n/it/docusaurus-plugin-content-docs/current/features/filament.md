...
Le bobine ufficiali Bambu Lab possono essere importate automaticamente tramite l'integrazione Bambu Cloud. Vedi [Bambu Cloud](../getting-started/bambu-cloud).
:::
