...
2. Compila:
   ...
   - **Cliente** — account cliente opzionale (vedi [E-commerce](../integrasjoner/ecommerce))
...
| Usura macchina | Calcolata dalla [Previsione Usura](../overvaaking/wearprediction) |
...
:::tip Prezzi orari
Attiva l'integrazione Tibber o Nordpool per costi energetici accurati per stampa. Vedi [Prezzo Energia](../integrasjoner/energy).
:::
...
:::info Dati cliente
I dati del cliente (nome, indirizzo, P.IVA) vengono recuperati dall'account cliente collegato al progetto. Vedi [E-commerce](../integrasjoner/ecommerce) per gestire i clienti.
:::
