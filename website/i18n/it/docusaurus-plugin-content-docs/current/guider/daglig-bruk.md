...
Vedi la [documentazione della coda di stampa](../funksjoner/queue) per informazioni complete sulla gestione della coda.
...
Vedi [Pianificatore](../funksjoner/scheduler) per i dettagli.
