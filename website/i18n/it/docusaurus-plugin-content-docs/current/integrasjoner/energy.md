...
L'integrazione prezzo energia attivata fornisce costi energetici accurati nel [Calcolatore Costi](../analyse/costestimator). Seleziona **Prezzo live** invece di un prezzo fisso per usare il prezzo Tibber/Nordpool attuale.
