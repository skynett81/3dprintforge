...
sidebar_position: 1
title: インストール
description: サーバーまたはローカルマシンに3DPrintForgeをインストールする
---
...
3DPrintForgeは、Node.js 22に組み込まれている`--experimental-sqlite`を使用します。古いバージョンはサポートされていません。
:::
...
3DPrintForgeにはGitHub Releasesを通じた組み込みの自動更新機能があります。**設定 → 更新**からダッシュボード上で更新できます。または手動で：
