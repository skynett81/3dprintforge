...
sidebar_position: 1
title: 설치
description: 서버 또는 로컬 컴퓨터에 3DPrintForge를 설치합니다
---
...
3DPrintForge는 Node.js 22에 내장된 `--experimental-sqlite`를 사용합니다. 이전 버전은 지원되지 않습니다.
:::
...
3DPrintForge는 GitHub Releases를 통해 내장 자동 업데이트를 제공합니다. **설정 → 업데이트**에서 대시보드를 통해 업데이트하거나 수동으로:
