...
description: MQTT 검색, 자동화된 엔티티 및 자동화 예제를 통해 Bambu Dashboard를 Home Assistant와 통합합니다
---
...
- Bambu Dashboard와 Home Assistant가 동일한 MQTT 브로커 사용
...
Bambu Dashboard가 이제 등록된 모든 프린터에 대한 Discovery 메시지를 게시합니다.
...
:::info 참고
버튼 (일시 정지/재개/정지)은 MQTT Discovery를 통해 게시되지 않습니다. 자동화에서 명령을 보내려면 Bambu Dashboard API를 사용하세요.
:::
