...
sidebar_position: 6
title: 키오스크 모드
description: 키오스크 모드 및 자동 순환 기능으로 3DPrintForge를 벽면 디스플레이 또는 허브 뷰로 설정합니다
---
...
:::tip 전용 사용자 계정
키오스크 장치를 위해 **게스트** 역할의 전용 3DPrintForge 사용자 계정을 만드세요. 그러면 장치가 읽기 전용 접근만 가지므로 누군가 화면에 접근하더라도 설정을 변경할 수 없습니다.
:::
