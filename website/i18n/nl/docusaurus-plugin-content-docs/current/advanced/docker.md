...
description: Bambu Dashboard uitvoeren met Docker en docker-compose
---

# Docker-installatie

Bambu Dashboard bevat een `Dockerfile` en `docker-compose.yml` voor eenvoudige containerisatie.
