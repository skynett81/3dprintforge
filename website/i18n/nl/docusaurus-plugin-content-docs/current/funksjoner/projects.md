...
2. Vul in:
   ...
   - **Klant** — optionele klantaccount (zie [E-commerce](../integrasjoner/ecommerce))
...
| Machineslijtage | Berekend op basis van [Slijtagepredictie](../overvaaking/wearprediction) |
...
:::tip Uurtarieven
Activeer de Tibber- of Nordpool-integratie voor nauwkeurige stroomkosten per print. Zie [Elektriciteitsprijs](../integrasjoner/energy).
:::
...
:::info Klantgegevens
Klantgegevens (naam, adres, KvK-nummer) worden opgehaald uit de klantaccount die u aan het project heeft gekoppeld. Zie [E-commerce](../integrasjoner/ecommerce) voor het beheren van klanten.
:::
