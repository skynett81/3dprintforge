...
Een geactiveerde elektriciteitsprijsintegratie geeft nauwkeurige stroomkosten in de [Kostencalculator](../analyse/costestimator). Selecteer **Live prijs** in plaats van een vaste prijs om de actuele Tibber/Nordpool-prijs te gebruiken.
