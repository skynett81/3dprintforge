...
3. W Bambu Dashboard: wklej token w **Token API Tibber**
...
Aktywowana integracja cen prądu zapewnia dokładne koszty prądu w [Kalkulatorze kosztów](../analyse/costestimator). Wybierz **Cena na żywo** zamiast stałej ceny, aby użyć aktualnej ceny Tibber/Nordpool.
