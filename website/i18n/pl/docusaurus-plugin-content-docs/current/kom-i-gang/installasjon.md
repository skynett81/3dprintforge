...
Przy pierwszym uruchomieniu dashboard generuje samopodpisany certyfikat SSL. Przeglądarka wyświetli ostrzeżenie — jest to normalne. Zobacz [Certyfikaty HTTPS](./oppsett#https-sertifikater), aby zainstalować własny certyfikat.
:::
...
Zobacz [Konfiguracja Docker](../avansert/docker), aby uzyskać pełną konfigurację.
