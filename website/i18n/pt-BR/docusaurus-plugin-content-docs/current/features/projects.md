...
2. Preencha:
   ...
   - **Cliente** — conta de cliente opcional (veja [E-commerce](../integrations/ecommerce))
...
| Desgaste da máquina | Calculado a partir da [Previsão de desgaste](../monitoring/wearprediction) |
...
:::tip Preços por hora
Ative a integração Tibber ou Nordpool para custos precisos de energia por impressão. Veja [Preço de energia](../integrations/energy).
:::
...
Os dados do cliente (nome, endereço, CNPJ) são obtidos da conta do cliente vinculada ao projeto. Veja [E-commerce](../integrations/ecommerce) para gerenciar clientes.
:::
