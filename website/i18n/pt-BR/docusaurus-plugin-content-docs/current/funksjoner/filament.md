...
As bobinas oficiais da Bambu Lab podem ser importadas automaticamente via integração Bambu Cloud. Veja [Bambu Cloud](../kom-i-gang/bambu-cloud).
:::
...
O Bambu Dashboard suporta etiquetas NFC para identificação rápida de bobinas:
