...
3. No 3DPrintForge: cole o token em **Token da API Tibber**
...
A integração de preço de energia ativada fornece custos de energia precisos na [Calculadora de custos](../analytics/costestimator). Selecione **Preço ao vivo** em vez de preço fixo para usar o preço atual do Tibber/Nordpool.
