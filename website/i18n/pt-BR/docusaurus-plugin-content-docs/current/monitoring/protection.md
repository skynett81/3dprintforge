...
O Print Guard é o sistema de monitoramento em tempo real do 3DPrintForge. Ele monitora continuamente a câmera, sensores e dados da impressora e executa ações configuráveis quando algo está errado.
