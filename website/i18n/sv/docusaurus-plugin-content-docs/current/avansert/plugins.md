...
sidebar_position: 4
title: Plugin-system
description: Skapa och installera plugins för att utöka Bambu Dashboard
---

# Plugin-system

Bambu Dashboard stöder ett plugin-system som låter dig utöka funktionaliteten utan att ändra källkoden.
