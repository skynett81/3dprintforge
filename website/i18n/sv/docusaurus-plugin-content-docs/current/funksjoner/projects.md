...
2. Fyll i:
   ...
   - **Kund** — valfritt kundkonto (se [E-handel](../integrasjoner/ecommerce))
...
| Maskinslitage | Beräknat från [Slitageprediktion](../overvaaking/wearprediction) |
...
:::tip Timpriser
Aktivera Tibber- eller Nordpool-integrationen för korrekta elkostnader per utskrift. Se [Elpris](../integrasjoner/energy).
:::
...
:::info Kunddata
Kunddata (namn, adress, org.nr.) hämtas från kundkontot du kopplade till projektet. Se [E-handel](../integrasjoner/ecommerce) för att administrera kunder.
:::
