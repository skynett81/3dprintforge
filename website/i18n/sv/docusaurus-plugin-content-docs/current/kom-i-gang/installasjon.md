...
Vid första start genererar instrumentpanelen ett självsignerat SSL-certifikat. Webbläsaren visar en varning — detta är normalt. Se [HTTPS-certifikat](./oppsett#https-sertifikater) för att installera ett eget certifikat.
:::
...
Se [Docker-konfiguration](../avansert/docker) för fullständig konfiguration.
