...
2. Välj en `.json`-fil exporterad från ett annat 3DPrintForge
3. Befintliga profiler med samma namn kan skrivas över eller båda behållas

## Dela profiler

Dela profiler med andra via community-filamentmodulen (se [Community-filamenter](../integrations/community)) eller via direkt JSON-export.
