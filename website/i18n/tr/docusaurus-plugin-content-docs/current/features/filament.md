...
Bambu Lab'ın resmi makaraları, Bambu Cloud entegrasyonu aracılığıyla otomatik olarak içe aktarılabilir. [Bambu Cloud](../getting-started/bambu-cloud) sayfasına bakın.
:::
