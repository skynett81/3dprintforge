...
2. Doldurun:
   ...
   - **Müşteri** — isteğe bağlı müşteri hesabı ([E-ticaret](../integrasjoner/ecommerce) sayfasına bakın)
...
| Makine aşınması | [Aşınma Tahmini](../overvaaking/wearprediction)'nden hesaplanmış |
...
Her baskı için doğru elektrik maliyetleri için Tibber veya Nordpool entegrasyonunu etkinleştirin. [Elektrik Fiyatı](../integrasjoner/energy) sayfasına bakın.
:::
...
Müşteri verileri (ad, adres, vergi no.) projeye bağladığınız müşteri hesabından alınır. Müşterileri yönetmek için [E-ticaret](../integrasjoner/ecommerce) sayfasına bakın.
:::
