...
Kuyruk yönetimi hakkında tam bilgi için [Baskı kuyruğu belgeleri](../funksjoner/queue) sayfasına bakın.
...
Ayrıntılar için [Zamanlayıcı](../funksjoner/scheduler) sayfasına bakın.
