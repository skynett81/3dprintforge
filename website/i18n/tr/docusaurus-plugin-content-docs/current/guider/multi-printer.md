...
Kurulum için [Bildirimler](./varsler-oppsett) bölümüne bakın.
...
- **AMS seviyelerini günlük kontrol edin**: Sabah rutini için [Günlük kullanım](./daglig-bruk) bölümüne bakın
