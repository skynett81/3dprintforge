...
3. 3DPrintForge'da: tokeni **Tibber API Tokeni** altına yapıştırın
...
Etkin elektrik fiyatı entegrasyonu, [Maliyet Hesaplayıcı](../analytics/costestimator)'da doğru elektrik maliyetleri sağlar. Mevcut Tibber/Nordpool fiyatını kullanmak için sabit fiyat yerine **Canlı Fiyat**'ı seçin.
