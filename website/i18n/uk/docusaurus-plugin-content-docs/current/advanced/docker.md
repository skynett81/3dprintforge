...
description: Запустіть 3DPrintForge за допомогою Docker та docker-compose
---

# Docker-налаштування

3DPrintForge включає `Dockerfile` та `docker-compose.yml` для зручної контейнеризації.
