...
description: Створюйте та встановлюйте плагіни для розширення Bambu Dashboard
---

# Система плагінів

Bambu Dashboard підтримує систему плагінів, яка дозволяє розширювати функціональність без зміни вихідного коду.
