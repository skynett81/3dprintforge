...
sidebar_position: 1
title: Встановлення
description: Встановіть Bambu Dashboard на свій сервер або локальний комп'ютер
---
...
Bambu Dashboard використовує `--experimental-sqlite`, вбудований у Node.js 22. Старіші версії не підтримуються.
:::
...
При першому запуску дашборд генерує самопідписаний SSL-сертифікат. Браузер відобразить попередження — це нормально. Дивіться [HTTPS-сертифікати](./oppsett#https-sertifikater) для встановлення власного сертифіката.
:::
...
Дивіться [Налаштування Docker](../avansert/docker) для повної конфігурації.
...
Bambu Dashboard має вбудоване автоматичне оновлення через GitHub Releases. Оновлення можна виконати з дашборду в розділі **Налаштування → Оновлення** або вручну:
