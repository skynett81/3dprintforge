...
Bambu Dashboard 支持通过多种渠道发送通知，让您无论在家还是外出都能随时了解打印机动态。
...
5. 在 Bambu Dashboard 中：粘贴令牌和 Chat-ID，点击**测试**
...
4. 复制 Webhook URL
5. 在 Bambu Dashboard 中粘贴 URL 并点击**测试**
...
4. 在 Bambu Dashboard 中填写两者并点击**测试**

### Webhook（自定义）

Bambu Dashboard 发送带有 JSON 负载的 HTTP POST 请求：
...
:::info PWA
将 Bambu Dashboard 安装为 PWA，可在无需打开标签页的情况下在后台接收推送通知。请参见 [PWA](../system/pwa)。
:::
